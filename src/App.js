...
// Constants
const TWITTER_HANDLE = 'saibejjani';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
// Add the domain you will be minting
const tld = '.fund';
const CONTRACT_ADDRESS = '0x964083245A38dC3C99583613432e5fd20D832C3E';

const App = () => {
  const [mints, setMints] = useState([]);
  //  stateful variable at the start of our component next to all the old ones
